...
class VendorController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('admin.vendor.edit',compact('data','categories','gs'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $user->vendorPercent()->delete();


        $categories_percent = $request->category;
        $array_of_percent = [];
        foreach($categories_percent as $key => $per) {
            if (!is_null($per)) {
                $new_per = new VendorPercentage();
                $new_per->category_id = $key;
                $new_per->percentage = $per;
                array_push($array_of_percent,$new_per);
            }


        }

        $user->vendorPercent()->saveMany($array_of_percent);
