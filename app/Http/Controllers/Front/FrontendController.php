...
// -------------------------------- HOME PAGE SECTION ----------------------------------------
	...
	public function index(Request $request)
	{
        ...
        $selectable = ['id','user_id','name','slug','category_id','features','colors','thumbnail','price','previous_price','attributes','size','size_price','discount_date'];
...
//        $services = DB::table('services')->where('user_id','=',0)->get()->each->setAppends(['translate_value']);
        ...
        $selectable = ['id','user_id','category_id','name','slug','features','colors','thumbnail','price','previous_price','attributes','size','size_price','discount_date'];
