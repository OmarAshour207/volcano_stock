...
// ************************************ FRONT SECTION **********************************************
  ...
  Route::get('/', 'Front\FrontendController@index')->name('front.index');
      ...
      Route::get('/translate_cat',function () {
          $categories = \App\Models\Product::all();

          foreach ($categories as $category) {
              $category_translate = new \App\Models\ProductTranslation();
              $category_translate->product_id = $category->id;
              $category_translate->locale = 'en';
              $category_translate->name = $category->name;
