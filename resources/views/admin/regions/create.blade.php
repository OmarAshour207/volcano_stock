                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="" action="{{route('admin-regions-store')}}" method="POST">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="number" class="input-field" name="price" placeholder="{{ __('Enter Price') }}" required="" value="">
                          </div>
                        </div>
