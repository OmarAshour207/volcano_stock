                        ...
                        @include('includes.vendor.form-both')
							  ...
							  @foreach($languages as $language)
								  <div class="row">
									  <div class="col-lg-4">
										  <div class="left-area">
											  <h4 class="heading">{{ __("Name $language") }} *</h4>
											  <p class="sub-heading">{{ __("$language") }}</p>
										  </div>
									  </div>
									  <div class="col-lg-7">
										  <input type="text" class="input-field" name="{{$language}}[name]" placeholder="{{ __('Enter Name') }}" required="">
									  </div>
								  </div>
							  @endforeach
							  ...
							  <div class="row">
								  <div class="col-lg-4">
									  <div class="left-area">
										  <h4 class="heading">{{ $langg->prodcut_affilate }}*</h4>
									  </div>
								  </div>
								  <div class="col-lg-7">
									  <input type="checkbox" name="is_affilate" />
								  </div>
							  ...
							  <div class="showbox">
                                  ...
                                  <option value="">{{ $langg->lang639 }}</option>
													  ...
													  <div class="size-area">
														  <div  class="row">
															  <div class="col-md-3 col-sm-6">
																  ...
																  <input type="number" name="weight" class="input-field" placeholder="{{ __('Weight') }}" value="1" min="1">
															  </div>
															  ...
															  <div class="col-md-3 col-sm-6">
																  ...
																  <input type="number" name="length" class="input-field" placeholder="{{ __('Length') }}" value="1" min="1">
															  </div>
															  <div class="col-md-3 col-sm-6">
																  <label>
																	  {{ __('Width') }} :
																  ...
																  <input type="number" name="width" class="input-field" placeholder="{{ __('Width') }}" value="1" min="1">
															  </div>
															  <div class="col-md-3 col-sm-6">
																  <label>
																	  {{ __('Height') }} :
																  ...
																  <input type="number" name="height" class="input-field" placeholder="{{ __('Height') }}" value="1" min="1">
															  </div>
														  </div>
													  </div>
												  </div>
										  ...
										  <div class="row">
											  <div class="col-lg-4">
												  <div class="left-area">
													  <h4 class="heading">{{ __('Free Shipping') }}</h4>
												  </div>
											  </div>
											  <div class="col-lg-7">
