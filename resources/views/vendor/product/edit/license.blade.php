                        ...
                        @include('includes.vendor.form-both')
											  @foreach($languages as $language)
												  <div class="row">
													  ...
													  <div class="col-lg-7">
														  <input type="text" class="input-field" name="{{$language}}[name]" placeholder="{{ __('Enter Name') }}" required="" value="{{$data->translate_value[$language]['name'] ?? '' }}">
													  </div>
												  </div>
											  @endforeach
											  ...
											  <div class="row">
												  ...
												  <div class="col-lg-7">
													  <input type="checkbox" name="is_affilate" {{$data->is_affilate == 1 ? 'checked' : ''}}/>
												  </div>
											  ...
											  <div class="row">
												  ...
												  <div class="col-lg-7">
													  <input type="checkbox" name="free_shipping" {{ $data->free_shipping == 1 ? 'checked' : ''}}/>
												  </div>
